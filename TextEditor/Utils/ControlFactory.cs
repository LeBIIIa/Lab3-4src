...
namespace ScintillaNET.Demo.Utils
{
	...
	public class ControlFactory
	{
        ...
        public static Control CloneCtrl(Control ctrl)
		{
			...
			Control newCtrl = CreateControl(cbCtrl.CtrlName, cbCtrl.PartialName);
	...
	{
        public static DataFormats.Format Format { get; } = DataFormats.GetFormat(typeof(CBFormCtrl).FullName);
